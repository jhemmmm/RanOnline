...
#include "../Lib -- Client/G-Logic/GLItemLink.h"
...
{
	EM_CHARSELECT_PASS_FB_SUB_OK             =  0, // 로그인 성공
	EM_CHARSELECT_PASS_FB_SUB_FAIL			  =  1, // 로그인 실패
	EM_CHARSELECT_PASS_FB_SUB_SYSTEM	      =  2, // 시스템에러로 로그인 실패
};
...
//	NET_MSG_PING_ANSWER		    = 151, //< 서버에서 ping 을 응답한다.	
	...
	/*security key on charselect, DevArt22*/
	CHINA_NET_MSG_CHARSELECT_PASS         = (NET_MSG_LOBBY + 183), //< China 로그인
	CHINA_NET_MSG_CHARSELECT_PASS_FB      = (NET_MSG_LOBBY + 184), //< China 로그인 결과 Agent->Client
