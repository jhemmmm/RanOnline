...
#include "../../Lib -- Network/s_NetGlobal.h" // struct VIEWLOGITEMEXCHANGEMAX; struct SHOPPURCHASE;
// #include "../../Lib -- Network/s_CDbAction.h" // class CDbAction;

#include "../../Lib -- Engine/Common/ByteStream.h" // class CByteStream;

#include "../../Lib -- Client/G-Logic/GLCharData.h" // struct SCHARDATA2;
#include "../../Lib -- Client/G-Logic/GLClubMan.h" // struct GLCLUBMEMBER; struct GLCLUBINFO;
#include "../../Lib -- Client/G-Logic/GLGuidance.h" // struct GLGUID_DB;
#include "../../Lib -- Client/G-Logic/GLPet.h" //struct GLPET;

/////////////////////////////////////////////////////////////////////////////
// LG-7 DLLCaller
#include "../Lib -- Client/LG7DLL.h"
/////////////////////////////////////////////////////////////////////////////
...
public:
	...
	*/
	...
	virtual int GetItemShop( std::vector<ITEMSHOP> &v ) { return 0; }  //itemmall
	...
	*/
	...
	virtual int SetItemShop( CString strItemNum, DWORD dwUserID ) { return 0; }//item mall
	...
	*/
	...
	//pk ranking
	virtual int GetPlayerRanking( PLAYER_RANKING_STATUS_MAP &m_pPlayerRanking ) { return 0; } 
	...
	virtual int InventoryLockEnable (DWORD dwChaNum, char* szChaName, char* szEPin ) { return 0; }
	virtual int InventoryLockInput (DWORD dwChaNum, char* szChaName, char* szEPin ) { return 0; }

	/*storage lock, DevArt22, 2020/02/11 */
	virtual int StorageLockEnable (DWORD dwChaNum, char* szChaName, char* szEPin ) { return 0; }
	virtual int StorageLockInput (DWORD dwChaNum, char* szChaName, char* szEPin ) { return 0; }
