...
/*inventory,equipment,storage lock, DevArt22, 2020/02/11 */
...
#include "../Lib -- Engine/DxSound/DxSoundLib.h"
...
#include "../Lib -- ClientUI/Interface/IngameItemMall/ItemMallIcon.h" //itemmall

#include "../Lib -- ClientUI/Interface/IngameItemMall/ItemShopWindow.h" //itemmall
...
/////////////////////////////////////////////////////////////////////////////
// LG-7 CharView
#include "CharViewWindow/CharViewWindow.h"
/////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////
// LG-7 CharView
void CInnerInterface::SetCharViewWindowOpen(BOOL bOpen)
{
	if (m_pCharViewWindow)
	{
		if (bOpen) ShowGroupFocus(CHAR_VIEW_WINDOW);
		else
		{
			m_pCharViewWindow->RESET();
			HideGroup(CHAR_VIEW_WINDOW);
		}
	}
}
/////////////////////////////////////////////////////////////////////////////
...
HRESULT CInnerInterface::InitDeviceObjects ( LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	// LG-7 CharView
	{
		m_pCharViewWindow = new CCharViewWindow;
		m_pCharViewWindow->Create(CHAR_VIEW_WINDOW, "BASIC_WINDOW", UI_FLAG_XSIZE | UI_FLAG_YSIZE);
		m_pCharViewWindow->CreateBaseWindowLightGray("BASIC_WINDOW", NULL);
		m_pCharViewWindow->CreateSubControl();
		m_pCharViewWindow->SetAlignFlag(UI_FLAG_CENTER_Y | UI_FLAG_CENTER_X);
		RegisterControl(m_pCharViewWindow, true);
		ShowGroupFocus(CHAR_VIEW_WINDOW);
	}
	/////////////////////////////////////////////////////////////////////////////
...
*/
	...
	{	/*equipment lock, Juver, 2018/01/13 */
		...
		/*inventory,equipment,storage lock, DevArt22, 2020/02/11 */
		m_pPersonalLockWindow = new CPersonalLockWindow;
		m_pPersonalLockWindow->Create( PERSONAL_LOCK_WINDOW, "PERSONAL_LOCK_WINDOW", UI_FLAG_CENTER_X | UI_FLAG_BOTTOM );
		m_pPersonalLockWindow->CreateSubControl ();
		RegisterControl ( m_pPersonalLockWindow );
		ShowGroupBottom ( PERSONAL_LOCK_WINDOW );

		m_pPersonalLockWindowDummy = new CUIControl;
		m_pPersonalLockWindowDummy->Create ( NO_ID, "PERSONAL_LOCK_WINDOW", UI_FLAG_CENTER_X | UI_FLAG_BOTTOM );
		RegisterControl ( m_pPersonalLockWindowDummy );
		m_pPersonalLockWindowDummy->SetVisibleSingle( FALSE );
