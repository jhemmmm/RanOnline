...
void CEquipmentLockEnableWindow::CreateSubControl()
{
	...
	m_pInfoDesc->SetText( ID2GAMEINTEXT( "RAN_EQUIPMENT_LOCK_ENABLE_INFO" ), NS_UITEXTCOLOR::PALEGREEN );
	RegisterControl ( m_pInfoDesc );

	m_pInfoDesc1 = new CBasicTextBox;
	m_pInfoDesc1->CreateSub ( this, "RAN_EQUIPMENT_LOCK_ENABLE_WINDOW_INFO_TEXT1", UI_FLAG_DEFAULT );
	m_pInfoDesc1->SetFont ( pFont08 );
	m_pInfoDesc1->SetTextAlign ( TEXT_ALIGN_LEFT );
	m_pInfoDesc1->SetText( ID2GAMEINTEXT( "RAN_EQUIPMENT_LOCK_ENABLE_INFO1" ), NS_UITEXTCOLOR::WHITE );
	RegisterControl ( m_pInfoDesc1 );

	m_pInfoDesc2 = new CBasicTextBox;
	m_pInfoDesc2->CreateSub ( this, "RAN_EQUIPMENT_LOCK_ENABLE_WINDOW_INFO_TEXT2", UI_FLAG_DEFAULT );
	m_pInfoDesc2->SetFont ( pFont08 );
	m_pInfoDesc2->SetTextAlign ( TEXT_ALIGN_LEFT );
	m_pInfoDesc2->SetText( ID2GAMEINTEXT( "RAN_EQUIPMENT_LOCK_ENABLE_INFO2" ), NS_UITEXTCOLOR::RED );
